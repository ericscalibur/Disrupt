...
function setupTransactionRowClicks(transactions) {
  ...
  function showTransactionDetails(txn) {
    ...
    const details = `
      ...
      ${txn.receiptId ? `<span class="label">Receipt:</span> <span class="data"><a href="#" onclick="viewReceipt('${escapeHtml(txn.receiptId)}');return false;" style="color:#5dade2;text-decoration:underline;">View Receipt</a></span>` : ""}
    `.trim();
